...
public class MapRealTimeActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sorcelat    = sharedPreferences.getString(Constants.SOURCE_CITY_LAT, Constants.JAIPUR_LAT);
        sorcelon    = sharedPreferences.getString(Constants.SOURCE_CITY_LON, Constants.JAIPUR_LON);
        ...
        surce       = sharedPreferences.getString(Constants.SOURCE_CITY, "Jaipur");
