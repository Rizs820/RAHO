...
public class LoginPresenter {
    ...
    public void ok_signUp(final String name, final String num, String pass, final Handler mhandler) {
        ...
        String uri = Constants.apilink + "userFunctions/signup.php?name=" + name + "&contact=" + num + "&password=" + pass;
    ...
    public void ok_login(final String num, String pass, final Handler mhandler) {
        ...
        String uri = Constants.apilink + "userFunctions/login.php?contact=" + num + "&password=" + pass;
        //Set up client
        OkHttpClient client = new OkHttpClient();
        //Execute request
