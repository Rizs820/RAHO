    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            ...
            case R.id.create :
                ...
                String mPhoneNumber = s.getString(Constants.USER_NUMBER, "8237061139");
                String name = s.getString(Constants.USER_NAME, "Harish Rahangdale");
                ...
                break;
            case R.id.download :
                intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=la.droid.qr"));
                break;
