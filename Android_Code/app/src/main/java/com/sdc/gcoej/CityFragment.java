...
import com.sdc.gcoej.destinations.description.FinalCityInfo;
import com.sdc.gcoej.destinations.funfacts.FunFacts;
...
public class CityFragment extends Fragment {
    ...
    private void tripAutoComplete() {
        ...
        String uri = Constants.apilink +
                "cityAPI/autocomplete.php?search=" + nameyet.trim();
        Log.e("executing", uri + " ");
                        ...
                        try {
                            ...
                            for (int i = 0; i < arr.length(); i++) {
                                try {
                                    ...
                                    list2.add(arr.getJSONObject(i).optString("image", "https://www.hindustantimes.com/rf/image_size_960x540/HT/p2/2017/01/13/Pictures/_cc13b502-d8f7-11e6-a260-7aa04c68bc63.jpg"));
                                    Log.e("adding", "aff");
    ...
    private void getCity() {
        ...
        // to fetch city names
        String uri = Constants.apilink + "get_cities.php";
        Log.e("executing", uri + " ");
    ...
    class CityAdapter extends BaseFlipAdapter<City> {
        ...
        public View getPage(int position, View convertView, ViewGroup parent, final City friend1, final City friend2) {
            ...
            switch (position) {
                case 1:
                    Picasso.with(getActivity()).load(friend1.getAvatar()).placeholder(R.drawable.jaipur).into(holder.leftAvatar);
                    ...
                    if (friend2 != null) {
                        ...
                        Picasso.with(getActivity()).load(friend2.getAvatar()).placeholder(R.drawable.jaipur).into(holder.rightAvatar);
                    }
                    break;
                default:
