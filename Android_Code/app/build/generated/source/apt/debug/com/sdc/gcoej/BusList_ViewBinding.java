...
public class BusList_ViewBinding implements Unbinder {
  private BusList target;

  @UiThread
  public BusList_ViewBinding(BusList target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public BusList_ViewBinding(BusList target, View source) {
    this.target = target;
